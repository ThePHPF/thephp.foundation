---
title: 'Welcoming Joe Watkins as a PHP Foundation Developer'
layout: post
tags:
  - news
author:
...
1. **Joe’s renewed health and momentum.** While we initially planned to bring Joe on board in August 2024, his health at the time didn’t allow it. After reviewing our budget post-H1 2025 and realizing we had extra room, we saw an opportunity to support Joe’s return and enable him to contribute once again.

2. **The impact of his work.** ORT is a concrete step toward making PHP more capable and future-proof. Beyond code, Joe has also contributed to the PHP process itself — having proposed and championed several process-related RFCs over the years that helped shape how PHP evolves.
...
Please join us in welcoming Joe back — and if you haven’t yet, check out what he’s been working on: [github.com/krakjoe](https://github.com/krakjoe).
