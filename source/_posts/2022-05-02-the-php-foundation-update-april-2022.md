...
We received about 70 applications in total. From them, we selected everyone who had significant experience making [php-src](https://github.com/php/php-src) contributions.
...
You can follow the Foundation team's work in real-time by looking at [commits in php/php-src](https://github.com/php/php-src/commits/master) and discussions in the [Internals mailing list](https://externals.io/).
...
We have started a separate [PHP Roundup](https://thephp.foundation/blog/2022/04/28/php-roundup-1/) newsletter that covers the development of the PHP core in more detail. Ayesh Karunaratne, the author of the [PHP.Watch](https://php.watch/) website, is leading this initiative.

Check it out and subscribe at [thephp.foundation/blog/2022/04/28/php-roundup-1/](https://thephp.foundation/blog/2022/04/28/php-roundup-1/).
...
## Website – [thephp.foundation](https://thephp.foundation/)

Thanks to the work of Matthew Weier O'Phinney, the foundation’s official website is now up and running. On its [blog](https://thephp.foundation/blog/), you can find all the updates and the PHP Roundup series.

The site is open source and is hosted on GitHub at [github.com/ThePHPF/thephp.foundation](https://github.com/ThePHPF/thephp.foundation).

It is made with the Sculpin static generator and uses Tailwind CSS. There are some [known issues](https://github.com/ThePHPF/thephp.foundation/issues), and pull requests with fixes and improvements are welcome.
